...
const hosts = [
  {
    name: "Vercel",
    icon: <svg viewBox="0 0 24 24" className="size-6 fill-slate-900" aria-hidden="true"><path d="M12 3l10 18H2L12 3z" /></svg>,
  },
  {
    name: "Netlify",
    icon: (
      <svg viewBox="0 0 24 24" className="size-6" aria-hidden="true">
        <g fill="none" stroke="#d946ef" strokeWidth="1.8">
...
const steps = [
  {
    title: "Test the exported site",
    desc: "Unzip the download and open the files through a local web server. Check layouts, links, forms and animations on desktop and mobile.",
  },
  {
    title: "Publish on your chosen host",
    desc: "Upload the tested files to Vercel, Netlify, Cloudflare Pages or GitHub Pages, then check the live site before changing your domain.",
  },
];
    ...
    <section className="relative border-t border-slate-100 bg-white py-20 sm:py-28">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <h2 className="font-display mt-6 max-w-3xl text-4xl font-bold leading-[1.1] tracking-tight text-slate-900 sm:text-5xl">
          Test your <span className="text-amber-500">exported site</span> then publish it.
        </h2>
        ...
        <div className="mt-14 grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col items-center">
            <div className="relative rounded-3xl border border-slate-200 bg-white px-12 py-9 text-center shadow-[0_24px_60px_rgba(245,158,11,0.12)]">
              <div
                className="pointer-events-none absolute -inset-8 -z-10 rounded-full bg-amber-200/20 blur-3xl"
                aria-hidden="true"
              />
            ...
            <svg className="my-1 h-14 w-72 text-amber-300" viewBox="0 0 288 56" fill="none" aria-hidden="true">
